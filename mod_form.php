...
class mod_exammanagement_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement(
            'text',
            'name',
            get_string('exammanagement_name', 'mod_exammanagement'),
        ...
        $mform->addElement(
            'password',
            'newpassword',
            get_string('new_password', 'mod_exammanagement'),
        ...
        $mform->addElement(
            'password',
            'confirmnewpassword',
            get_string('confirm_new_password', 'mod_exammanagement'),
        ...
        if (isset($oldpw) || (!isset($_GET['update']) && !isset($_GET['add']))) {
            $mform->addElement(
                'password',
                'oldpassword',
                get_string('old_password', 'mod_exammanagement'),
                ['size' => '64', 'autocomplete' => "off"]
            );
