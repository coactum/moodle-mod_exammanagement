...
Sitzplätze können dabei entweder manuell (nach einem Klick auf den entsprechenden Button) oder aber automatisiert zugewiesen werden.<br /> <br />
Für die automatisierte Zuweisung muss zunächst der Zuweisungsmodus für die Sitzplätze gewählt werden. Folgende drei Alternativen sind möglich:<br />
...
Nach einem Klick auf den Button "Sitzplätze automatisch zuweisen" werden dann die Sitzplätze gemäß den gewählten Einstellungen zugewiesen. Schon bestehende Zuweisungen werden dabei überschrieben. Bereits bestehende Zuweisungen lassen sich zudem über den entsprechenden Button komplett zurücksetzen.';
