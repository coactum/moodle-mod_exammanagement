...
$string['import_bonus_from_file'] = 'Bonuspunkte aus Excel-Datei importieren; Benutzeridentifikator (PANDA-Benutzerid oder IMT-Login) und Bonuspunkte müssen in den oben ausgewählten Spalten stehen).';
