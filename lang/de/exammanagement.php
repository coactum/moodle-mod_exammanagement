...
$string['helptext_participantsOverview']= 'In dieser <strong>Teilnehmer- und Ergebnisübersicht</strong> können, sobald Prüfungsteilnehmerinnen importiert wurden, alle Informationen zu diesen und alle für sie eingetragenen Ergebnissen angesehen und bearbeitet werden. <br><br>
Für jeden der alphabetisch sortiert angezeigten Prüfungsteilnehmerinnen werden standardmäßig sowohl der Vor- und der Nachname als auch die Matrikelnummer angezeigt. Wurden einem oder einer Teilnehmenden bereits ein Sitzplatz zugewiesen wird dieser sowie der zugehörige Raum ebenfalls angezeigt. Wurden bereits Prüfungsaufgaben angelegt und wurden für einen Teilnehmer bereits Prüfungsergebnisse eingetragen werden diese ebenfalls angezeigt. In der Spalte Punkte wird dabei angezeigt, wie viele Punkte der Teilnehmer in jeder einzelnen Aufgabe erreicht hat, während in der Spalte Gesamtpunkte die aufsummierte Gesamtpunktezahl angezeigt wird. Wurden noch keine Prüfungsaufgaben angelegt kann dies nach einen Klick auf das stattdessen angezeigte Symbol erledigt werden. Wurde noch kein Notenschlüssel eingetragen kann dies nach einem Klick auf das entsprechende Symbol in der Spalte Ergebnis getan werden, andernfalls wird in dieser Spalte (falls für den Teilnehmer bereits Ergebnisse eingetragem wurden) dessen aus dem Notenschlüßel berechnete Prüfungsnote angezeigt. Hat der Teilnehmer einen besonderen Status (was er etwa bei der Prüfung krank oder liegt bei ihm ein Betrugsversuch vor) wird dies auch in der Spalte des Prüfungsergebnisses angezeigt. Außerdem stehen in der Spalte Bonusschritte die bereits vom Teilnehmenden errungenen Bonusnotenschritte für die Klausur, während in der Spalte Ergebnis mit Bonus die Endnote unter berücksichtigung der Bonusnotenschritte angesehen werden kann. <br><br>
Um einen Prüfungsteilnehmer zu bearbeiten reicht ein Klick auf das Icon rechts in der Zeile des jeweiligen Prüfungsteilnehmenden. Danach können alle Angaben für den oder die Studierende bearbeitet werden. So können dem oder der Teilnehmenden zum Beispiel einer der bereits für die Prüfung als Prüfungsraum ausgewählten Räume und ein beliebiger Sitzplatz in diesem zugewiesen werden. In der Spalte Punkte können dagegen für aufgabenweise die vom Prüfling erreichten Punkte eingetragen werden. Alternativ kann falls nötig zudem aus einem Dropdown-Menü ein besonderer Prüfungsstatus wie etwa Krank, Nicht Teilgenommen (NT) oder aber Täuschungsversuch ausgewählt werden, wodurch die Punkte automatisch auf Null gesetzt werden. Es können außerdem manuell die von einem Prüfling erreichten Bonusschritte ausgewählt werden. Nach dem Speichern der Änderungen durch einen Klick auf den entsprechenden Button werden dann (falls bereits ein Notenschlüssel eingetragen wurde) das Ergebniss sowie das Ergebnis unter Berücksichtigung aller errungenen Bonusnotenschritte berechnet. <br><br>
Für einen Studierenden können dabei alle diese Angaben gleichzeitig oder aber Jede einzeln eingetragen beziehungsweise bearbeitet werden. Auf diese Weise kann diese Seite etwa genutzt werden, um für Prüfungsteilnehmende manuell Ergebnisse einzutragen oder diesen händisch die gewünschten Sitzplätze zuzuweisen.';
