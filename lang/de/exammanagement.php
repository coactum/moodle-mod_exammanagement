...
$string['date_room_examreview_set'] = 'Die Klausureinsicht findet am <strong>{$a->examreviewtime}</strong> in Raum <strong>{$a->examreviewroom}</strong> statt.';
...
$string['enableglobalmessage_help'] = 'Wird diese Option aktiviert wird die folgende globale Mitteilung beim Anlegen einer neuen Prüfungsorgainsation angezeigt.';
$string['globalmessage'] = 'Globale Mitteilung';
$string['globalmessage_help'] = 'Text der globalen Mitteilung die beim Anlegen einer neuen Prüfungsorganisation angezeigt wird falls die obige Option aktiviert ist.';
...
$string['ldapdn_help'] = 'In diesem Feld muss der "distinguished name" (kurz "dn") eingetragen werden. Dieser beschreibt die Positionierung der Einträge in ihrem LDAP-System. Wird dieses Feld leer gelassen nutzt das Plugin bei aktiviertem LDAP den Wert "contexts" aus den globalen Einstellungen des Authentifizierungsplugins LDAP-Server ("auth_ldap"). Ist keines dieser beiden Felder ausgefüllt können die vom LDAP abhängigen Pluginfunktionen nicht genutzt werden.';
$string['ldap_objectclass'] = 'LDAP-Klasse des Teilnehmer-Objekts';
$string['ldap_objectclass'] = 'Hier kann ein Klassenname eingetragen werden der dann als zusätzliches Filterkriterium für das Teilnehmerobjekt im LDAP verwendet wird.';
