...
$string['moodleid_supportuser'] = 'Moodle ID of the support user';
$string['moodleid_supportuser_help'] = 'The user whose system internal ID has been entered here will receive all messages automatically generated by the users upon requesting a reset of the password of an exam organization. The user (preferably a user created exclusively for support with one of the roles admin, manager or course creator) receives the message both as a PANDA notification and forwarded to the e-mail address stored in his profile. If no ID has been entered here yet, users cannot request the reset of a password for their exam organization.';
