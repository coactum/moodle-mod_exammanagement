...
$string['password_reset_successfull'] = 'The password of the exam organisation was successfully reset and all teachers of the PANDA course were informed about this via PANDA message.';
