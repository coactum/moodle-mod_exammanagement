...
$string['not_all_places_assigned_yet'] = 'Some participants still have to be assigned places before you can continue with the further work steps.';
...
$string['gradingscale_set'] = 'A grading scale has already been configured.';
...
$string['exam_results_altered'] = '<strong>{$a}</strong> exam results have been altered after exam.';
...
$string['export_altered_examresults_str'] = 'Here you can export the results changed after the exam as a text document.';
...
$string['checkPassword_help'] = 'A password for this exam management was set by the teacher. You have to enter it below to gain access to the content of this module. <br><br> By clicking on the corresponding button, you can request a password reset via support if necessary. If the password has been reset, you and all other teachers of the '. get_config('mod_exammanagement', 'moodlesystemname').' course will be informed via '. get_config('mod_exammanagement', 'moodlesystemname').' notification.';
$string['checkPassword_link'] = get_config('mod_exammanagement', 'additionalressources');
$string['checkPasswordAdmin_help'] = 'A password for this exam management was set by the teacher. You have to enter it below to gain access to the content of this module. <br> <br>
Admins can reset the password of the exam organization here if teachers request this. All teachers of the '. get_config('mod_exammanagement', 'moodlesystemname').' course will be informed about this via '. get_config('mod_exammanagement', 'moodlesystemname').' message.';
$string['checkPasswordAdmin_link'] = get_config('mod_exammanagement', 'additionalressources');
$string['configurePassword_help'] = 'On this page, you can set or change the password for the exam organization. This password has to be entered by every teacher of the '. get_config('mod_exammanagement', 'moodlesystemname').' course in order to access the contents of the exam organization.<br><br>
...
$string['addCustomRoom_help'] = 'On this page, you as a lecturer can create a <strong>custom exam room</strong> if the room in which you want to hold your exam is not listed as an exam room within the system. Alternatively, you can also edit an existing exam room you have created yourself here.<br><br>
...
$string['addParticipants_help']= 'On this page you can add <strong>participants</strong> from exam lists to the exam. In this way their results can be exported later again list by list and then simply be reimported. <br /> <br />
...
$string['addCourseParticipants_help']= 'Here you can import all <strong>course participants</strong> enrolled in '. get_config('mod_exammanagement', 'moodlesystemname').'  as exam participants. <br><br>
...
<strong>Please note:</strong> If this variant of participant import is selected, the results of all participants added in this way will be exported later in a single separate list for the exam office, which may make it difficult to reimport them. If you plan to have the exam results reimported, you may want to add participants to the exam using the appropriate participants lists in the corresponding import.';
$string['addCourseParticipants_link'] = get_config('mod_exammanagement', 'additionalressources');
$string['configureTasks_help']= 'Here you can define the number and maximum points of all <strong>exam tasks</strong>. <br><br>
...
<strong>Note:</strong> In order to give the participants more detailed information about the auxiliary means permitted in the exam, for example, the free text field accessible via the overview page can also be used.';
...
$string['configureGradingscale_help']= 'Here a <strong>grading scale</strong> can be configured for the exam.<br><br>
...
$string['enableldap_help'] = 'Checking this box allows the plugin for exam organization to use an external LDAP server specified in the system to determine the basic data of the exam participants, such as their matriculation numbers. In order for this to work, the external LDAP server must be available and <a href="https://docs.moodle.org/35/en/LDAP_authentication">configured</a> in Moodle. In addition, in the following settings the "distinguished name" (short dn) and the names of all LDAP fields containing the information required by the plugin must be entered. Once this is done, the plugin automatically uses the data stored in the LDAP. Otherwise the corresponding plugin functionalities (e.g. the import of participants or the entering of results after matriculation number or the export of exam labels) are not available.';
$string['ldapdn'] = '"Distinguished name" (short "dn")';
$string['ldapdn_help'] = 'The "distinguished name" (short "dn") must be entered in this field. This describes the positioning of the entries in your LDAP system. If this field is left empty, the plugin uses the value "contexts" from the global settings of the authentication plugin LDAP server ("auth_ldap") when LDAP is activated. If neither of these two fields is filled in, the LDAP dependent plugin functions cannot be used.';
$string['ldap_objectclass_student'] = 'LDAP class of the student object';
$string['ldap_objectclass_student_help'] = 'The class name of the participant object from the LDAP must be entered here. If this is not done, the exam results cannot be entered according to matriculation numbers.';
$string['ldap_field_map_username'] = 'Field username';
$string['ldap_field_map_username_help'] = 'The name of the field in the LDAP system in which the user name of the participant is located must be entered here. This user name must match the user name of the participant in '. get_config('mod_exammanagement', 'moodlesystemname').'. If this field is left empty, the plugin uses the value "field_map_idnumber" from the global settings of the authentication plugin LDAP server ("auth_ldap") when LDAP is activated. If neither of these two fields is filled in, the LDAP dependent plugin functions cannot be used.';
$string['ldap_field_map_matriculationnumber'] = 'Field matriculation number';
$string['ldap_field_map_matriculationnumber_help'] = 'The name of the field in the LDAP system in which the participants matriculation number is located must be entered here. If this field is not filled in, all plugin functions that require matriculation numbers (e.g. entering results by matriculation number or displaying or exporting matriculation numbers) cannot be used.';
$string['ldap_field_map_firstname'] = 'Feld firstname';
$string['ldap_field_map_firstname_help'] = 'The name of the field in the LDAP system in which the participants given name is located must be entered here. If this field is left empty, the plugin uses the value "field_map_firstname" from the global settings of the authentication plugin LDAP server ("auth_ldap") when LDAP is activated. If neither of these two fields is filled in, participants that have no valid '. get_config('mod_exammanagement', 'moodlesystemname').' account can not be imported as exam participants.';
$string['ldap_field_map_lastname'] = 'Feld lastname';
$string['ldap_field_map_lastname_help'] = 'The name of the field in the LDAP system in which the participants surname is located must be entered here. If this field is left empty, the plugin uses the value "field_map_lastname" from the global settings of the authentication plugin LDAP server ("auth_ldap") when LDAP is activated. If neither of these two fields is filled in, participants that have no valid '. get_config('mod_exammanagement', 'moodlesystemname').' account can not be imported as exam participants.';
$string['ldap_field_map_mail'] = 'Feld emailadress';
$string['ldap_field_map_mail_help'] = 'The name of the field in the LDAP system in which the participants mail adress is located must be entered here. If this field is left empty, the plugin uses the value "field_map_email" from the global settings of the authentication plugin LDAP server ("auth_ldap") when LDAP is activated. If neither of these two fields is filled in, participants that have no valid '. get_config('mod_exammanagement', 'moodlesystemname').' account can not be imported as exam participants.';
