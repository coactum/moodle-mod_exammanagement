    ...
    public function definition(){
        ...
        if($moodleParticipants){
            ...
            if($moodleParticipants){
                ...
                $mform->addElement('html', '<div class="panel-heading"><h3 class="panel-title">' . count($moodleParticipants) . ' ' . get_string("participants_convertable", "mod_exammanagement"). '</h3>');
