    ...
    public function definition() {
        ...
        if ($this->_customdata['bonuscount']) {
            $mform->addElement('html', '<div class="alert alert-warning alert-block fade in " role="alert">
                ...
                get_string(
                    "bonus_already_entered",
                    "mod_exammanagement",
                    ['bonuscount' => $this->_customdata['bonuscount']]
                ) . '</div>');
        }
        ...
        if (!isset($this->_customdata['mode'])) {
            $select = $mform->addElement(
                'select',
                'bonusmode',
                get_string('bonus_import_mode', 'mod_exammanagement'),
        ...
        if (!isset($this->_customdata['mode'])) {
            ...
            $mform->addGroup(
                $bonusstepbuttons,
                'bonusstep_buttonarray',
                get_string('add_remove_bonusstep', 'mod_exammanagement'),
                [' '],
                false
            );
            ...
            $mform->addGroup(
                $bonussstepnumbers,
                'bonussstepnumbers_array',
                get_string('bonusstep', 'mod_exammanagement'),
                '',
                false
            );
            $mform->addGroup(
                $bonussteps,
                'bonussteppoints_array',
                get_string('required_points', 'mod_exammanagement'),
                ' ',
                false
            );
